...
<script>
    document.querySelectorAll('.space-arrow').forEach(btn => {

        btn.addEventListener('click', () => {

            const slider = btn.closest('.space-slider-wrap')
                .querySelector('.space-scroll');
    ...
    document.querySelectorAll('.space-scroll').forEach(slider => {
